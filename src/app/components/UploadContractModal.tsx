...
import { IconUpload, IconX, IconFileTypeDocx } from "@tabler/icons-react";
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden rounded-2xl">
        <div className="px-6 pt-6 pb-5">
          ...
          {/* File drop zone — hidden once file selected */}
          {!file && (
            <div
          ...
          {file && (
            <div className="flex items-center gap-3 border border-gray-200 rounded-xl px-4 py-3 mb-5">
              ...
              >
                <IconX size={11} strokeWidth={2.5} className="text-gray-600" />
              </button>
            </div>
          )}
